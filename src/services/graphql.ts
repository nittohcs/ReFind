...
import { floorsByTenantId, getFileDownloadUrl, getFileUploadUrl, getTenant, listTenants, seatOccupanciesByDateAndTenantId, seatsByTenantId, usersByTenantId } from "@/graphql/queries";
